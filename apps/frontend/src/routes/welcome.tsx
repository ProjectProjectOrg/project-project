...
function InviteRow({
  ...
  return (
    <li
      className={cn(
        "group flex items-start gap-3 border-b border-border px-4 py-3.5 transition-colors last:border-b-0 hover:bg-muted/30 sm:items-center sm:gap-4",
    ...
    >
      ...
      >
        <span className="font-mono text-[15px] leading-none font-medium text-foreground">
          {initial}
        </span>
      </div>
      <div className="min-w-0 flex-1 space-y-0.5">
        <div className="flex min-w-0 items-center gap-2">
          <span className="min-w-0 truncate text-[14px] leading-5 font-medium text-foreground">
            {invite.orgName}
          </span>
