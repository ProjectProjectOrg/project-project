...
import { type EditorPreference, FigmaAuthInvalid, FigmaError } from "@pp/shared"
...
function GithubDisconnectConfirm({
  ...
  return (
    <>
      <span className="inline-flex h-8 items-center text-xs whitespace-nowrap text-muted-foreground">
