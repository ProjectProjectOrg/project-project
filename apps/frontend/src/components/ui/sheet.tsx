  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        className={cn(
          "fixed z-50 flex flex-col bg-background shadow-lg duration-200 outline-none data-[closed]:animate-out data-[closed]:fill-mode-forwards data-[open]:animate-in",
