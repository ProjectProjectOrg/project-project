...
export function TicketGitChip({
  ...
  if (state.tag === "branch_no_pr" || state.tag === "branch_pending") {
    return (
      <span
        className={cn("inline-flex max-w-full min-w-0 items-center", pulse)}
      >
        <BranchChip
          slug={repoSlug}
          name={state.name}
...
export function BranchChip({
  ...
  if (variant === "ghost") {
    return (
      <a
        ...
        title={name}
        className="inline-flex max-w-full min-w-0 items-center gap-1 rounded-md px-1.5 py-0.5 font-mono text-xs text-muted-foreground transition-colors duration-100 hover:bg-accent hover:text-foreground"
      >
  ...
  return (
    <span
      className="inline-flex max-w-full min-w-0 items-center gap-1.5 rounded-md bg-muted pr-1 font-mono text-xs text-muted-foreground transition-colors duration-100 hover:text-foreground"
      title={name}
    >
      <a
        {...link}
