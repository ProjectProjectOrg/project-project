...
import { userJiraIntegration, userJiraOauthState } from "@pp/db/schema"
import {
  JiraError,
  JiraNotConnected,
  JiraRateLimited,
...
export type JiraAccessToken = Readonly<{
  token: Redacted.Redacted<string>
}>

export type JiraCredentialsShape = Readonly<{
  status: (userId: string) => Effect.Effect<JiraConnection>
  beginConnect: (
    userId: string,
    returnPath: string
  ...
  >
  disconnect: (userId: string) => Effect.Effect<JiraConnection>
}>

type JiraCredentialsInternalShape = Readonly<
  JiraCredentialsShape & {
    returnPathForState: (
      userId: string,
      state: string
...
>()("@pp/server-core/jira/Credentials/JiraCredentials") {}
