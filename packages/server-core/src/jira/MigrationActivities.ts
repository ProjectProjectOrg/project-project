...
export type ScanPageDependencies = Readonly<{
  client: JiraClientShape
  artifacts: JiraMigrationArtifactsShape
  progress: (
    fence: AttemptFence,
    page: {
      kind: JiraScanKind
...
export type ScanSnapshotDependencies = Readonly<
  ScanPageDependencies & {
    identityOptions: Effect.Effect<
