...
import { JiraError, JiraRateLimited, JiraReconnectRequired } from "@pp/shared"
...
export type JiraTokenGrant = Readonly<{
  accessToken: string
  refreshToken: string
  expiresAt: Date
...
>()("@pp/server-core/jira/OAuth/JiraOAuthConfig") {}
...
export type JiraTokenEndpointShape = Readonly<{
  exchange: (
    code: string,
...
>()("@pp/server-core/jira/OAuth/JiraTokenEndpoint") {}
