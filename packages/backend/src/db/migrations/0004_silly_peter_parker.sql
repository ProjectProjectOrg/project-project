...
--> statement-breakpoint
ALTER TABLE "project_index" RENAME COLUMN "owner_id" TO "created_by";--> statement-breakpoint
ALTER TABLE "project_index" ADD COLUMN "id" uuid DEFAULT gen_random_uuid() NOT NULL;--> statement-breakpoint
ALTER TABLE "project_index" ADD COLUMN "organization_id" text;--> statement-breakpoint
ALTER TABLE "project_member" ADD COLUMN "project_id" uuid;--> statement-breakpoint
