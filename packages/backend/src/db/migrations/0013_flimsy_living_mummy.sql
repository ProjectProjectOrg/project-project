...
ALTER TABLE "project_integration_link" ADD CONSTRAINT "project_integration_link_org_integration_id_organization_id_fkey" FOREIGN KEY ("organization_integration_id","organization_id") REFERENCES "public"."organization_integration"("id","organization_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "project_integration_link_org_integration_idx" ON "project_integration_link" USING btree ("organization_integration_id");--> statement-breakpoint
CREATE UNIQUE INDEX "project_index_id_organization_uidx" ON "project_index" USING btree ("id","organization_id");